  ...
  return (
    <footer className="bg-green-800 text-white text-center py-8 mt-12">
      ...
      <div className="flex justify-center gap-4 mt-4 text-sm">
        <a href="https://www.linkedin.com/company/cell-ag-argentina" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Cell Ag Argentina en LinkedIn">
        ...
        <a href="https://www.instagram.com/cellagargentina" target="_blank" rel="noopener noreferrer" className="footer-social-link" aria-label="Cell Ag Argentina en Instagram">
