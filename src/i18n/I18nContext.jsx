...
const translations = {
  es: {
    ...
    capa: {
      ...
      tickets: "Entrada presencial · Crossing Over", streamingTicket: "Entrada al streaming", streamingTicketLabel: "Comprar entrada virtual para el streaming de CAPA 2026", discount: "15% de descuento", discountLabel: "Código CAPAXO: 15% de descuento",
  ...
  en: {
    ...
    capa: {
      ...
      tickets: "In-person ticket · Crossing Over", streamingTicket: "Streaming ticket", streamingTicketLabel: "Buy a virtual streaming ticket for CAPA 2026", discount: "15% off", discountLabel: "CAPAXO code: 15% off",
