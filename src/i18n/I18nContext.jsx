...
const translations = {
  es: {
    ...
    capa: {
      ...
      tickets: "Entrada presencial · Crossing Over", streamingTicket: "Entrada al streaming", streamingTicketLabel: "Comprar entrada virtual para el streaming de CAPA 2026", discount: "15% de descuento en entrada presencial", discountLabel: "Código CAPAXO: 15% de descuento exclusivo para la entrada presencial de Crossing Over",
  ...
  en: {
    ...
    capa: {
      ...
      tickets: "In-person ticket · Crossing Over", streamingTicket: "Streaming ticket", streamingTicketLabel: "Buy a virtual streaming ticket for CAPA 2026", discount: "15% off the in-person ticket", discountLabel: "CAPAXO code: 15% off exclusively for the in-person Crossing Over ticket",
